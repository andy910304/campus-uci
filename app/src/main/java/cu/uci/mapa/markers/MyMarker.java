...
public class MyMarker extends Marker {
	...
	public MyMarker(Activity activity,Context ctx, MapView mapView, LatLong latLong,
	...
	public boolean onTap(LatLong tapLatLong, Point layerXY, Point tapXY) {
		if (this.contains(layerXY, tapXY)) {
			...
			text.append(ctx.getResources().getString(R.string.loc) + "\n");
            ...
            //toast.setGravity(Gravity.BOTTOM, 0, 0);
            //toast.show();
			Log.d("Latitude", tapLatLong.latitude + "");
			Log.d("Latitude", tapLatLong.longitude + "");
			return true;
		}
    ...
    private void showOptionDialog(final LatLong latlong) {
        ...
        StringBuilder text = new StringBuilder();
        text.append(mapView.getResources().getString(R.string.marker) + ":" + "\n");
        ...
        MaterialDialog dialog = new MaterialDialog.Builder(this.ctx)
                ...
                .icon(mapView.getResources().getDrawable(R.drawable.ic_mapa_nav))
                .cancelable(true)
                .theme(Theme.LIGHT)
                ...
                .callback(new MaterialDialog.ButtonCallback() {
                    ...
                    public void onPositive(MaterialDialog dialog) {
                        ...
                        //Intent i = new Intent(ctx.getApplicationContext(), SalvarFavorito.class);
                        //i.putExtra("LATITUDE", latlong1.latitude);
                        //i.putExtra("LONGITUDE", latlong1.longitude);
                        //ctx.startActivity(i);
                        //mapView.getLayerManager().getLayers().remove(MyMarker.this);
                    }
