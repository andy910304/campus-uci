...
public class ActionButton extends View {
	...
	/**
	 * <b>Action Button</b> color in {@link cu.uci.utils.FloatingButtonLib.ActionButton.State#NORMAL} state
	 */
	private int buttonColor = Color.LTGRAY;

	/**
	 * <b>Action Button</b> color in {@link cu.uci.utils.FloatingButtonLib.ActionButton.State#PRESSED} state
	 */
	...
	/**
	 * Initializes the {@link cu.uci.utils.FloatingButtonLib.ActionButton.Type} of <b>Action Button</b>
	 *
	 * @param attrs attributes of the XML tag that is inflating the view
	 */
	 ...
	 * {@link #state} set to {@link cu.uci.utils.FloatingButtonLib.ActionButton.State#NORMAL}
	 *  
	 * @param attrs attributes of the XML tag that is inflating the view
	 */
	...
	/**
	 * Initializes the <b>Action Button</b> color for
	 * {@link #state} set to {@link cu.uci.utils.FloatingButtonLib.ActionButton.State#PRESSED}
	 * 
	 * @param attrs attributes of the XML tag that is inflating the view
	 */
	 ...
	 * {@link cu.uci.utils.FloatingButtonLib.ActionButton.State#NORMAL} state
	 * 
	 ...
	 * {@link cu.uci.utils.FloatingButtonLib.ActionButton.State#NORMAL} state and invalidates the view
	 *  
	 * @param buttonColor <b>Action Button</b> color 
	 *                    when in {@link cu.uci.utils.FloatingButtonLib.ActionButton.State#NORMAL} state
	 */
	...
	/**
	 * Sets the <b>Action Button</b> color when in
	 * {@link cu.uci.utils.FloatingButtonLib.ActionButton.State#PRESSED} state
	 *  
	 * @return <b>Action Button</b> color when in
	 * {@link cu.uci.utils.FloatingButtonLib.ActionButton.State#PRESSED} state
	 */
	...
	/**
	 * Sets the <b>Action Button</b> color when in
	 * {@link cu.uci.utils.FloatingButtonLib.ActionButton.State#PRESSED} state and invalidates the view
	 * 
	 * @param buttonColorPressed <b>Action Button</b> color
	 *                           when in {@link cu.uci.utils.FloatingButtonLib.ActionButton.State#PRESSED} state
	 */
	...
	/**
	 * Sets one of the {@link cu.uci.utils.FloatingButtonLib.ActionButton.Animations} as animation, which is used while showing
	 * <b>Action Button</b>
	 *
	 * @param animation one of the {@link cu.uci.utils.FloatingButtonLib.ActionButton.Animations}, which is to be used while
	...
	/**
	 * Sets one of the {@link cu.uci.utils.FloatingButtonLib.ActionButton.Animations} as animation, which is used while hiding
	 * <b>Action Button</b>
	 *
	 * @param animation one of the {@link cu.uci.utils.FloatingButtonLib.ActionButton.Animations}, which is to be used while
	 ...
	 * 1. Changes the <b>Action Button</b> {@link #state} to {@link cu.uci.utils.FloatingButtonLib.ActionButton.State#PRESSED}
	 *    on {@link android.view.MotionEvent#ACTION_DOWN}
	 * 2. Changes the <b>Action Button</b> {@link #state} to {@link cu.uci.utils.FloatingButtonLib.ActionButton.State#NORMAL}
