...
import cu.uci.utils.MaterialDialog.base.base.DialogBase;
import cu.uci.utils.MaterialDialog.base.util.DialogUtils;
import cu.uci.utils.MaterialDialog.base.util.RecyclerUtil;
import cu.uci.utils.MaterialDialog.base.util.TypefaceHelper;
...
public class MaterialDialog extends DialogBase implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context) {
            ...
            final int materialAccent = context.getResources().getColor(R.color
                    .primary_color);
            final int materialBlue = context.getResources().getColor(R.color.md_material_blue_600);
            final int materialGreen = context.getResources().getColor(R.color.fab_material_green_500);
            final int materialRed = context.getResources().getColor(R.color.fab_material_red_500);
            final int materialGrey = context.getResources().getColor(R.color.neutral_color);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                TypedArray a = context.getTheme().obtainStyledAttributes(new int[]{android.R.attr.colorAccent});
                try {
                    this.accentColor = materialAccent;
                    this.positiveColor = materialGreen;
                    this.negativeColor = materialRed;
                    this.neutralColor = materialGrey;
                } catch (Exception e) {
                    this.accentColor = materialAccent;
                    this.positiveColor = materialGreen;
                    this.negativeColor = materialRed;
         ...
         * {@link #typeface(String, String)} and {@link #typeface(android.graphics.Typeface, android.graphics.Typeface)}.
         *
         ...
         * @deprecated Use {@link #adapter(android.widget.ListAdapter, ListCallback)} instead.
         */
        @Deprecated
